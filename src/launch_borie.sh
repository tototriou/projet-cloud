...
ssh -A -t aristide-briand << EOF
    ...
    sudo cp ~/projet-cloud-virt/conf_nomad_consul/nomad_borie.hcl /etc/nomad.d/nomad.hcl
    sudo cp ~/projet-cloud-virt/conf_nomad_consul/consul_borie.hcl /etc/consul.d/consul.hcl
