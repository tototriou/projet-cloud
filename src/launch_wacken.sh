...
ssh -A -t wacken << EOF
    ...
    sudo cp ~/projet-cloud-virt/conf_nomad_consul/nomad_wacken.hcl /etc/nomad.d/nomad.hcl
    sudo cp ~/projet-cloud-virt/conf_nomad_consul/consul_wacken.hcl /etc/consul.d/consul.hcl
