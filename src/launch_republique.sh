...
ssh -A -t republique << EOF ## republique is the name of the machine
    ...
    sudo cp ~/projet-cloud/conf_nomad_consul/nomad_republique.hcl /etc/nomad.d/nomad.hcl
    sudo cp ~/projet-cloud/conf_nomad_consul/consul_republique.hcl /etc/consul.d/consul.hcl
